...
class WPListTable
{
	...
	{
		die('function WPListTable::ajax_user_can() must be overridden in a subclass.');
	}
	...
	{
		die('function WPListTable::prepare_items() must be overridden in a subclass.');
	}
...
<p class="search-box">
	...
	{
		die('function WPListTable::get_columns() must be overridden in a subclass.');
	}
...
<table class="wp-list-table <?php echo implode(' ', $this->get_table_classes()); ?>">
	...
	/**
	 * Gets a list of CSS classes for the WPListTable table tag.
	 *
	 * @since 3.1.0
	 *
