...
- **GraphQL transport:** HTTP POST to [`Env::graphql_api_uri()`](src/Env.php) (`/api/graphql`); HMAC `signing_input` path is [`Env::graphql_signing_path()`](src/Env.php) (`/graphql` — back-app route after nginx strips `/api`).
